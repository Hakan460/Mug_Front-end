    ...
    <ImageBackground source={{ uri: BG_IMAGE_URL }} style={styles.background}>
      <View style={styles.overlay}>
        ...
        <View style={styles.menuContainer}>
          ...
          <TouchableOpacity style={styles.menuItem} onPress={() => router.push('/(owner)/business-settings' as any)}>
            <Ionicons name="storefront-outline" size={22} color={Colors.primary} />
            <Text style={styles.menuText}>İşletmemi Yönet</Text>
            <Ionicons name="chevron-forward" size={18} color="#555" style={styles.menuChevron} />
          </TouchableOpacity>

          <TouchableOpacity style={styles.menuItem} onPress={() => router.push('/(owner)/services-settings' as any)}>
            <Ionicons name="cut-outline" size={22} color={Colors.primary} />
            <Text style={styles.menuText}>Hizmetlerimi Yönet</Text>
            <Ionicons name="chevron-forward" size={18} color="#555" style={styles.menuChevron} />
          </TouchableOpacity>

          <TouchableOpacity style={styles.menuItem} onPress={() => router.push('/(owner)/staff-settings' as any)}>
            <Ionicons name="people-outline" size={22} color={Colors.primary} />
            <Text style={styles.menuText}>Uzmanlarımı Yönet</Text>
            <Ionicons name="chevron-forward" size={18} color="#555" style={styles.menuChevron} />
          </TouchableOpacity>
