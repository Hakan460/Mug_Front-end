...
export default function ProfileScreen({ userRole, onLogout }: ProfileScreenProps) {
  return (
    <ImageBackground source={{ uri: BG_IMAGE_URL }} style={styles.background}>
      <View style={styles.overlay}>
        ...
        <View style={styles.menuContainer}>
          ...
          <TouchableOpacity style={styles.menuItem}>
            <Ionicons name="shield-checkmark-outline" size={22} color="#D4AF37" />
          ...
          <TouchableOpacity style={[styles.menuItem, styles.logoutItem]} onPress={onLogout}>
            ...
            <Text style={[styles.menuText, { color: '#E74C3C' }]}>Sistemden Güvenli Çıkış</Text>
          </TouchableOpacity>
        </View>
      </View>
    </ImageBackground>
...
const styles = StyleSheet.create({
  ...
  overlay: { flex: 1, backgroundColor: 'rgba(0, 0, 0, 0.75)', padding: 20, justifyContent: 'center' },
  profileCard: { alignItems: 'center', marginBottom: 40 },
  avatar: { width: 100, height: 100, borderRadius: 50, borderWidth: 3, borderColor: '#D4AF37', marginBottom: 15 },
  name: { fontSize: 24, fontWeight: 'bold', color: '#FFF' },
  badge: { backgroundColor: 'rgba(212, 175, 55, 0.15)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20, marginTop: 8, borderWidth: 1, borderColor: 'rgba(212, 175, 55, 0.4)' },
  badgeText: { color: '#D4AF37', fontWeight: 'bold', fontSize: 13 },
  menuContainer: { backgroundColor: '#1A1A1A', borderRadius: 20, padding: 10, borderWidth: 1, borderColor: '#333' },
  menuItem: { flexDirection: 'row', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderBottomColor: '#222' },
  logoutItem: { borderBottomWidth: 0 },
  menuText: { color: '#FFF', fontSize: 16, marginLeft: 12, fontWeight: '500' }
});